/**
 * English is the default: it is the language a shared link has to read in for
 * whoever opens it. French is the cookbook's own language and stays one click
 ...
 * primary subtag is matched: a Quebec browser is still a French one.
 */
